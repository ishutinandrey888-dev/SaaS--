        ...
        <section className="mt-10">
          ...
          <div className="mt-4 space-y-4 text-sm text-ink-700">
            ...
            <Block title="Что такое тарифы Pro и Agency?">
              Pro — 3 990 ₽/мес: до 20 запусков агентов в месяц, 50
              AI-улучшений, история 30 дней. Agency — 13 900 ₽/мес: безлимитные
              агенты, безлимитные AI-улучшения, история без срока.
            </Block>
          </div>
        </section>
      </div>
