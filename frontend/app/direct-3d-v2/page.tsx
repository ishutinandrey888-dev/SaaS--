...
function Direct3DShowcase() {
  return (
    <section id="direct-3d" style={{ padding: "20px 40px 110px" }}>
      <div style={{
        maxWidth: 1200,
        margin: "0 auto",
        display: "grid",
        ...
        borderRadius: 28,
        padding: "44px",
        background: "radial-gradient(circle at 76% 20%, rgba(43,96,255,0.24), transparent 34rem), #111418",
        overflow: "hidden",
        position: "relative",
      }}>
        <div style={{ position: "relative", zIndex: 2 }}>
          <div style={{ fontSize: 11, fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.1em", color: "#4ADE80", marginBottom: 16 }}>
            Яндекс Директ в объёме
          </div>
          <h2 style={{ fontFamily: "'Unbounded', sans-serif", fontSize: "clamp(28px, 3.5vw, 46px)", fontWeight: 900, lineHeight: 1.08, letterSpacing: "-0.03em", marginBottom: 18 }}>
            Знакомые элементы кабинета,<br />но с AI-слоем действий
          </h2>
          <p style={{ color: "#94A3B8", fontSize: 16, lineHeight: 1.7, maxWidth: 520, marginBottom: 26 }}>
            Мы не рисуем абстрактный “искусственный интеллект”. Визуал собирается из того, что директолог узнаёт сразу: кампании, ставки, фразы, предпросмотр объявления, клики и бюджетные утечки.
          </p>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 12 }}>
            {[
              ["Жёлтая стрелка", "Ведёт внимание от клика к заявке."],
              ["Таблица кампаний", "Показывает, что AI работает с реальным кабинетом."],
              ["Промо-карточка", "Связывает объявления, офферы и посадочную."],
              ["Сканер фраз", "Находит мусорные запросы до слива бюджета."],
            ].map(([title, body]) => (
              <div key={title} style={{
                minHeight: 118,
                padding: 18,
                ...
                <div style={{ color: "#F0F4F8", fontSize: 14, fontWeight: 800, marginBottom: 8 }}>{title}</div>
                <div style={{ color: "#94A3B8", fontSize: 13, lineHeight: 1.55 }}>{body}</div>
              </div>
            ))}
          </div>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .direct-blue-stack {
          ...
          transform-style: preserve-3d;
          animation: directStageFloat 8s ease-in-out infinite;
        }
        .direct-blue-stack i {
          position: absolute;
          inset: 0;
          border-radius: 32px;
          background: linear-gradient(145deg, #38caff, #2761ff 58%, #0c39c2);
          box-shadow: 0 42px 110px rgba(0,0,0,0.34), inset 0 1px 0 rgba(255,255,255,0.32);
        }
        .direct-blue-stack i:nth-child(2) {
          left: 54px;
          top: 54px;
          background: linear-gradient(145deg, #2f6bff, #0c45df);
          transform: translateZ(-70px);
          opacity: 0.9;
        }
        .direct-blue-stack i:nth-child(3) {
          left: 104px;
          top: 104px;
          background: linear-gradient(145deg, #194eea, #0a2da8);
          transform: translateZ(-130px);
          opacity: 0.72;
        }
        .direct-campaign-plane {
          position: absolute;
          left: 6%;
          top: 28%;
          width: 470px;
          ...
          transform: rotateX(56deg) rotateZ(-12deg) translateZ(86px);
          animation: directPlaneFloat 7s ease-in-out infinite;
        }
        .direct-campaign-pill {
          display: inline-flex;
          align-items: center;
          min-height: 32px;
          padding: 0 14px;
        ...
        .direct-campaign-row strong {
          color: #536079;
          font-size: 11px;
        }
        .direct-campaign-row em {
          justify-self: end;
          color: #219C46;
          font-style: normal;
        }
        .direct-coin {
          ...
          height: 156px;
          border-radius: 50%;
          background: conic-gradient(from 312deg, #0a3f99 0 23%, #ffe12e 23% 74%, #0a3f99 74% 100%);
          box-shadow: inset 0 0 0 10px #f4f8ff, inset 0 0 0 16px rgba(44,56,82,0.48), 0 24px 70px rgba(43,96,255,0.38);
          transform: rotateX(12deg) rotateY(-16deg) translateZ(220px);
          animation: directCoinFloat 6s ease-in-out infinite;
        }
        .direct-coin::before {
          content: "";
          position: absolute;
        ...
        .direct-glass-card {
          ...
          min-height: 158px;
          padding: 22px;
          background: linear-gradient(118deg, rgba(255,255,255,0.78), rgba(216,235,255,0.32));
          transform: rotateY(-18deg) rotateX(7deg) translateZ(140px);
        }
        .direct-glass-card i {
          display: block;
          height: 13px;
          ...
          box-shadow: -32px 0 0 -1px rgba(255,255,255,0.62);
        }
        .direct-action-card {
          right: 9%;
          bottom: 13%;
          ...
          transform: rotateY(-16deg) rotateX(8deg) translateZ(170px);
        }
        .direct-action-card span,
        .direct-loss-card span {
          display: block;
          color: #64748b;
          font-size: 10px;
          font-weight: 900;
        ...
        .direct-loss-card {
          ...
          transform: rotateY(18deg) rotateX(8deg) translateZ(160px);
        }
        .direct-loss-card strong {
          color: #F87171;
          font-size: 21px;
        }
        .direct-click {
          ...
          height: 86px;
          border-radius: 50%;
          border: 1px solid rgba(255,225,46,0.66);
          color: #ffe12e;
          background: rgba(255,225,46,0.12);
          box-shadow: 0 0 0 12px rgba(255,225,46,0.08), 0 24px 70px rgba(255,225,46,0.2);
          transform: translateZ(240px);
          animation: directClickPulse 2.4s ease-in-out infinite;
        }
        @keyframes directStageFloat {
          0%, 100% { transform: rotateX(58deg) rotateZ(-13deg) translateY(0); }
          50% { transform: rotateX(58deg) rotateZ(-11deg) translateY(-14px); }
        }
        @keyframes directPlaneFloat {
          0%, 100% { transform: rotateX(56deg) rotateZ(-12deg) translateZ(86px) translateY(0); }
          50% { transform: rotateX(56deg) rotateZ(-10deg) translateZ(96px) translateY(-12px); }
        }
        @keyframes directCoinFloat {
          0%, 100% { transform: rotateX(12deg) rotateY(-16deg) translateZ(220px) translateY(0); }
          50% { transform: rotateX(14deg) rotateY(-8deg) translateZ(238px) translateY(-16px); }
        }
        @keyframes directClickPulse {
          0%, 100% { opacity: 0.72; transform: translateZ(240px) scale(0.92); }
          50% { opacity: 1; transform: translateZ(260px) scale(1.06); }
        }
...
function Direct3DScene() {
  return (
    <div className="direct-showcase-stage" aria-hidden="true">
      <div className="direct-blue-stack">
        <i />
        <i />
        <i />
      </div>
      <div className="direct-campaign-plane">
        <div className="direct-campaign-pill">Yandex Direct</div>
        <div className="direct-campaign-tabs">
          <span>Кампании</span>
          <span>CPA</span>
          <span>Расход</span>
        </div>
        {[
          ["РСЯ · Автошкола", "1 190 ₽", "−35%"],
          ["Поиск · Новокузнецк", "CPC 42 ₽", "+18%"],
          ["Фразы · категория B", "128 минус", "−112к"],
        ].map(([name, metric, delta]) => (
          <div key={name} className="direct-campaign-row">
            <span>{name}</span>
      ...
      <div className="direct-coin" />
      <div className="direct-glass-card">
        <i />
        <i />
        <i />
      </div>
      <div className="direct-click">клик</div>
      <div className="direct-loss-card">
        <span>утечка</span>
        <strong>−34 200 ₽</strong>
      </div>
